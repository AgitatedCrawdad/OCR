...
def order_point(pts):
    ...
    #and the fourth i the bottom-left
    ...
    #point will have the smallest difference, whereas the bottom-left will
...
def four_point_transform(image, pts):
    ...
    # x-coordiatepips or the top-right and top-left x-coordinates
